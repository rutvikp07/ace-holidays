<?php
        ...
        if(isset($_POST['submit'])){
            ...
            $check ="select * from 'one-day' where des_name='$des_name'" ;
            ...
            <script>
                alert('Already added!')
                window.location.href='https://aceholidays07.000webhostapp.com/admin_panel.html';
            </script>
            <?php
            }
            else{
            ...
            if(in_array($filecheck,$fileextstored)){
                ...
                $insert = "INSERT INTO 'one-day' (des_name,description,price,days,nights,image) VALUES ('$des_name','$des','$price','$days','$nights','$path')";
                $query = mysqli_query($con,$insert);
    
               

                $display = "SELECT * FROM 'one-day' ";
                ...
                while($result = mysqli_fetch_array($q_dis)){
                    ...
                    <a href="admin_delete.php"><input type="submit" class="btn" name="delete" value="delete"></a>
                    </div>
                    <style>
                        .tables{
